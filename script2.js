...
fetch(
  ...
  .then((data) => {
    ...
    // add hero biography details in page
    ...
    // add hero powerstats details in page
    ...
    // add  hero appearance details in page
