...
function addFavourite(id) {
  if (!arr.includes(id) == true) {
    ...
    alert("Your hero is already added in favourites section !")
  }
}
          ...
          html += `
            <div class="card" style="width: 18rem;">
              ...
              <div class="card-body">
                  ...
                  <span><i id="${element.id}" class="fa-sharp fa-solid fa-heart icon" onclick="addFavourite(${element.id})"></i></span>
              </div>
            </div>
                `;
        });
